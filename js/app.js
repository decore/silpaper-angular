...
var app = angular.module('vsApp', ['ngRoute', 'use-info']);
  ...
  app.config(function($routeProvider) {
    $routeProvider.
      ...
      when('/production', { templateUrl:'partial/production.html'}).
      when('/cutting', { templateUrl:'partial/cutting.html'}).
      when('/certificates', { templateUrl:'partial/certificates.html'}).
